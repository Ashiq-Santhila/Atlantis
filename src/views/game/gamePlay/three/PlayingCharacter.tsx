...
const PlayingChracter: React.FC = () => {
    ...
    return (    
      <group ref={groupRef}>      
        ...
        {/* <primitive object={gltf.scene} position={[0, -2.5 , 0]} />   For Single view old  */}
        <primitive object={gltf.scene} position={[8, -2.6 , 0]} />   {/* For Single view  new for NDI*/} 
        <mesh rotation={[-Math.PI / 2, 0, 0]} position={[2, 5, 0]} receiveShadow onClick={handleClick} >            
