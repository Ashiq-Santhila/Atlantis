...
console.log(path);
  return ( 
    <Box
    transform={path.startsWith('/game/play') ||path.startsWith('/admin/superadmin/game/creation') || path.startsWith('/admin/superadmin/game/template') || path.startsWith('/admin/game/preview/') ? 'translateX(-100%)' : 'translateX(0)'}
